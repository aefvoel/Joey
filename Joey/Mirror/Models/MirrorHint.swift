...
struct MirrorHint {
    ...
    static let hints = [
        MirrorHint(
            ...
            plainText: ["I believe that I am worthy of love", "I believe that I'm worthy of love"]
        ),
        MirrorHint(
            hint: "I'm different in my own beautiful way",
            plainText: ["I am different in my own beautiful way", "I'm different in my own beautiful way"]
        ),
        MirrorHint(
        ...
        MirrorHint(
            ...
            plainText: ["I am allowed to say no to others and yes to myself", "I'm allowed to say no to others and yes to myself"]
        ),
        MirrorHint(
        ...
        MirrorHint(
            ...
            plainText: ["I am talented and intelligent", "I'm talented and intelligent"]
        ),
        MirrorHint(
            hint: "I'm thankful for all that I have",
            plainText: ["I am thankful for all that I have", "I'm thankful for all that I have"]
        ),
        MirrorHint(
            hint: "I am brave. I am bold. I am strong",
            plainText: ["I am brave I am bold I am strong", "I'm brave I'm bold I'm strong"]
        ),
        MirrorHint(
            hint: "I'm in control of my thoughts, feelings, and choices",
            plainText: ["I am in control of my thoughts feelings and choices", "I'm in control of my thoughts feelings and choices"]
        ),
        MirrorHint(
            hint: "I will not compare myself to strangers on the internet",
            plainText: ["I will not compare myself to strangers on the internet", "I will not compare myself to strangers on the internet"]
        ),
        MirrorHint(
        ...
        MirrorHint(
            ...
            plainText: ["I am blessed with a wonderful family and amazing friends", "I'm blessed with a wonderful family and amazing friends"]
        ),
        MirrorHint(
        ...
        MirrorHint(
            ...
            plainText: ["I am open to new adventures in my life", "I'm open to new adventures in my life"]
        ),
        MirrorHint(
            hint: "I'm smart enough to make my own decisions",
            plainText: ["I am smart enough to make my own decisions", "I'm smart enough to make my own decisions"]
        ),
        MirrorHint(
